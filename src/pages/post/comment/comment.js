...
const CommentBox = () => {
  ...
  return (
    <div className={styles.comment}>
        ...
        {images.map((image, index) => (
          ...
          >
            <img
              ...
              width="178"
              height="100"
              style={{ margin: "10px", borderRadius: "8px", cursor: "zoom-in",objectFit: "cover" }}
      ...
      <div>{errorMsg && <div className={styles.error}>{errorMsg}</div>}</div>
      ...
      <div>
        <div className={styles.sendcomment}>
          ...
          <div className={styles.commentContent}>
            ...
            <div className={styles.commentText}>12121</div>
              ...
              <div style={{ display: "flex" }}>
                ...
                <span className={styles.commentReply} onClick={handleReply}>
                  {showReply ? (
                    ...
                    <span style={{ color: "#ff6b6b" }}>取消回复</span>
                  )}
                </span>
                <span
